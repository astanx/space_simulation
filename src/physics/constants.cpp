...
const glm::dvec3 mercuryPerihelion = glm::vec3(4.6e10, 0.0, 0.0);
...
const glm::dvec3 venusPerihelion = glm::vec3(1.082e11, 0.0, 0.0);
...
const glm::dvec3 earthPerihelion = glm::dvec3(1.4709845e11, 0.0, 0.0);  
...
const glm::dvec3 moonPerihelion = earthPos + glm::dvec3(3.626e8, 0.0f, 0.0f); 
